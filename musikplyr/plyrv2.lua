...
-- Frame Utama (Tinggi dibuat lebih ringkas: 260px)
...
miniCorner.CornerRadius = UDim.new(1, 0) -- Membuat bentuk lingkaran penuh
...
-- 4. Main Scroll Container (Agar UI ringkas & bisa di-scroll)
...
mainScroll.CanvasSize = UDim2.new(0, 0, 0, 320) -- Tinggi total area scroll
...
-- Playlist Container (ScrollingFrame internal untuk daftar lagu)
...
-- Minimize & Restore Logic (Ke Logo/Ikon Kecil)
