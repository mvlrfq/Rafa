...
local function showNotification(title, text, duration)
    ...
    -- Hapus notifikasi sebelumnya jika masih muncul
...
local PageCustom = createTab("Waypoint", false) -- Set false agar layout terkontrol khusus
...
-- Container Kontrol Atas (Tombol Aksi)
local WaypointTopControls = Instance.new("Frame")
WaypointTopControls.Size = UDim2.new(1, 0, 0, 140)
...
WaypointDivider.Position = UDim2.new(0, 0, 0, 145)
...
WaypointListBox.Size = UDim2.new(1, -6, 1, -155)
WaypointListBox.Position = UDim2.new(0, 0, 0, 150)
...
-- --- TAB 2: WAYPOINT (Memakai Frame Kontrol Atas) ---
